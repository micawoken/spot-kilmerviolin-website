/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 971eb77aa58a89219251bf3862866482)
// Runtime types generated with workerd@1.20260804.1 2026-06-22 nodejs_compat
interface __BaseEnv_Env {
	KV_DB_CACHE: KVNamespace;
	R2_FILES: R2Bucket;
	EMDASH_MEDIA: R2Bucket;
	DB_MAIN: D1Database;
	EMDASH_DB: D1Database;
	RL_FREQ: RateLimit;
	RL_API_PUBLIC: RateLimit;
	RL_API_ADMIN_GLOBAL: RateLimit;
	RL_API_ADMIN_USER: RateLimit;
	RL_ADMIN_RENDER: RateLimit;
	RL_API_FILES_READ: RateLimit;
	RL_API_FILES_WRITE: RateLimit;
	...
	KV_CACHE_TTL: 57600;
	CF_ANALYTICS_SITE_TAG: "5dc8ad0bb3c74cbb8fe7a434edcbac97";
	FALLBACK_EMAIL_DOMAIN: "fallback.invalid";
	WORKER_ORIGIN: "https://spot-kilmerviolin.nrnnet.workers.dev";
	API_USER_SELFENROLL: false;
	REBUILD_COOLDOWN_SEC: 1800;
	IDENTITY_CACHE_TTL_MS: 45000;
	...
	R2_QUOTA: DurableObjectNamespace<import("./src/worker").R2Quota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "R2Quota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CACHE_API_TTL" | "CACHE_API_TTL_LONG" | "KV_CACHE_TTL" | "CF_ANALYTICS_SITE_TAG" | "FALLBACK_EMAIL_DOMAIN" | "WORKER_ORIGIN" | "API_USER_SELFENROLL" | "REBUILD_COOLDOWN_SEC" | "IDENTITY_CACHE_TTL_MS" | "MAX_UPLOAD_BYTES" | "SEARCH_RESULT_CAP" | "MAX_IMAGE_WIDTH" | "TARGET_IMAGE_FORMAT" | "TARGET_IMAGE_QUALITY" | "CF_ACCESS_TOKEN" | "CF_DEPLOY_HOOK" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET" | "CF_ANALYTICS_TOKEN" | "CF_ACCESS_POLICY_ID" | "CF_ACCOUNT_ID" | "CF_ACCESS_AUD" | "TEAM_DOMAIN" | "TURNSTILE_SECRET">> {}
}
