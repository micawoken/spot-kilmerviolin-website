...
CREATE INDEX idx_contact_responses_read_at ON contact_responses (read_at);
CREATE INDEX idx_contact_responses_entry_date ON contact_responses (entry_date);
...
CREATE TRIGGER trg_contact_responses_entry_date_immutable
