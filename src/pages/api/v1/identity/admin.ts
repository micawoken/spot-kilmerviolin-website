 ...
 * @param elevate - true to elevate the listed users, false to demote them
 * @returns a Response object
 */
async function _processAdmin(context: APIContext, request: Request, elevate: boolean): Promise<Response> {
 ...
 * Elevates the contributor records mapped to the provided identity emails (sets admin = true)
 *
...
export const PUT: APIRoute = async (context): Promise<Response> => {
    ...
    return _processAdmin(context, request, true)
}

/**
 * DELETE /api/v1/identity/admin
 * Demotes the contributor records mapped to the provided identity emails (sets admin = false)
 *
 * Permissions required: *admin*
 *
 * Meta: none
...
export const DELETE: APIRoute = async (context): Promise<Response> => {
    ...
    return _processAdmin(context, request, false)
}
