...
/**
 * Whether the string appears to be a valid phone number
 *
 * @param {string} value - the candidate phone number
 * @returns {boolean} - true if the value is a plausibly valid phone number
 */
