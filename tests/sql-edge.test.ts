...
describe("SQLStatement.finish guards", () => {
    ...
    it("orders full-table INSERT parameters by schema column order and fills missing columns with null", () => {
        ...
        // schema order: composer_id, name, role, birth_year, death_year, country, bio, image, tags, entry_date
        expect(params).toEqual([null, "Test Person", null, "1900", null, "Nowhere", null, null, null, null])
    })
